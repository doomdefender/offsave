...
- Procesamiento y recorte local con FFmpeg.
...
4. Cuando se solicita un fragmento, FFmpeg recorta el archivo local.
5. El archivo temporal se elimina al terminar la solicitud.

Este flujo evita que FFmpeg intente abrir directamente enlaces temporales de
las plataformas, que suelen exigir encabezados, cookies o firmas que vencen.
